...
const socialLinks = [
  {
    icon: FaLinkedin,
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/kaif-ansari-8644061aa',
  },
  {
    icon: FaGithub,
    label: 'GitHub',
    href: 'https://github.com/rockxkaif',
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="group relative card-tilt">
              ...
              <div className="relative bg-white/60 dark:bg-gray-900/60 backdrop-blur-md rounded-2xl p-8 border border-white/20 dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-glassTextLight mb-6">Contact Information</h3>
                <div className="space-y-6">
                  {contactInfo.map((info) => (
                    ...
                    >
                      <div className="p-3 rounded-lg bg-glassAccent/20 border border-glassAccent/30">
            ...
            <div className="group relative card-tilt">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-glassAccent to-glassLavender rounded-xl blur opacity-0 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
              <div className="relative bg-white/60 dark:bg-gray-900/60 backdrop-blur-md rounded-2xl p-8 border border-white/20 dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-glassTextLight mb-6">Connect with Me</h3>
                <div className="flex space-x-4">
                  {socialLinks.map((link) => (
                    <motion.a
                      ...
                      className="p-3 rounded-lg bg-glassAccent/20 border border-glassAccent/30 text-glassAccent hover:bg-glassAccent/30 transition-colors glass-glow"
          ...
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-glassAccent to-glassLavender rounded-xl blur opacity-0 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
            <div className="relative bg-white/60 dark:bg-gray-900/60 backdrop-blur-md rounded-2xl p-8 border border-white/20 dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
              <h3 className="text-2xl font-bold text-glassTextLight mb-6">Send a Message</h3>
